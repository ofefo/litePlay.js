...
- [litePlay online editor](https://vlazzarini.github.io/litePlay.js/): a simple editor designed to test experimental features with REPL. It supports JS Code inside the textarea, and litePlay's functions can be called without the prefix. Saving code and uploading media files aren't currently supported.
